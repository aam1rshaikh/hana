...
function InstagramChatSection() {
  ...
  const stats = [
    ...
    { emoji: "📅", value: "800", label: "days on instagram", sub: "and many more to come Insha Allah" },
...
export default function App() {
  ...
  useEffect(() => {
    // Check for hash in URL (e.g., #instagram-chat)
  ...
  return (
    <>
      ...
      <link rel="preload" as="style" href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,600;1,400&family=Lora:ital@0;1&family=Special+Elite&display=swap" />
