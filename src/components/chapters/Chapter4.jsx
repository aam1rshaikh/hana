  ...
  return (
    <div id="chapter-4" style={{ background: "linear-gradient(180deg,#0d0d1a 0%,#12122a 40%,#1a1a3a 70%,#0f0f20 100%)", padding: "80px 20px", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        <Fade delay={0.2}><p style={{ color: "rgba(255,255,255,0.75)", lineHeight: 1.95 }}>I miss you ma'am, a lot. There is not just a single aspect that I miss about you, it's everything. It's not that I just miss the conversations we used to have all the time, it's you that I miss the most. Your laugh, your quirks, the way you said certain things (banaene, tamata), the gossip, your thoughts, your warmth, just everything about you.</p></Fade>
        <Fade delay={0.1}><p style={{ color: "rgba(255,255,255,0.75)", lineHeight: 1.95 }}>I miss you whenever I see the moon or when I see the beautiful sunset or the beautiful sky. I miss you, not only when I am alone doing nothing but also when I am surrounded by people all around.</p></Fade>
